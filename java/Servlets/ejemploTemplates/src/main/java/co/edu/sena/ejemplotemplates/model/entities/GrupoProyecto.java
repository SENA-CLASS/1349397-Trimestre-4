...
public class GrupoProyecto implements Serializable {
    ...
    @JoinColumn(name = "numero_ficha", referencedColumnName = "numero_ficha", insertable = false, updatable = false)
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.GrupoProyecto[ grupoProyectoPK=" + grupoProyectoPK + " ]";
    }
