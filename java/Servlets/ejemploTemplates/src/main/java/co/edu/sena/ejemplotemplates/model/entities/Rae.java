...
public class Rae implements Serializable {
    ...
    @JoinTable(name = "rae_has_trimestre", joinColumns = {
        @JoinColumn(name = "rae_codigo", referencedColumnName = "codigo")
        , @JoinColumn(name = "competencia_codigo", referencedColumnName = "competencia_codigo")
        , @JoinColumn(name = "programa_codigo_version", referencedColumnName = "programa_codigo_version")}, inverseJoinColumns = {
        @JoinColumn(name = "id_trimestre", referencedColumnName = "id_trimestre")
        , @JoinColumn(name = "jornada", referencedColumnName = "jornada_nombre")})
    ...
    @JoinColumns({
        ...
        , @JoinColumn(name = "programa_codigo_version", referencedColumnName = "programa_codigo_version", insertable = false, updatable = false)})
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.Rae[ raePK=" + raePK + " ]";
    }
