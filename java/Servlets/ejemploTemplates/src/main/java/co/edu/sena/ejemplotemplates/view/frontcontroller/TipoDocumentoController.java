...
import co.edu.sena.ejemplotemplates.controller.ejbs.TipoDocumentoFacade;
...
public class TipoDocumentoController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.TipoDocumentoFacade ejbFacade;
