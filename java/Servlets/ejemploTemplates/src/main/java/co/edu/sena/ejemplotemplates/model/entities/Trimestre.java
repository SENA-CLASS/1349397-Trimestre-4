...
public class Trimestre implements Serializable {
    ...
    @JoinColumn(name = "jornada_nombre", referencedColumnName = "nombre", insertable = false, updatable = false)
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.Trimestre[ trimestrePK=" + trimestrePK + " ]";
    }
