...
public class Competencia implements Serializable {
    ...
    @JoinColumn(name = "programa_codigo_version", referencedColumnName = "codigo_version", insertable = false, updatable = false)
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.Competencia[ competenciaPK=" + competenciaPK + " ]";
    }
