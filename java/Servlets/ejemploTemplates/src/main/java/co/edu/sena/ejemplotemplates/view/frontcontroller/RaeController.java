...
import co.edu.sena.ejemplotemplates.model.entities.Rae;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.RaeFacade;
...
public class RaeController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.RaeFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setRaePK(new co.edu.sena.ejemplotemplates.model.entities.RaePK());
    }
    ...
    public Rae getRae(co.edu.sena.ejemplotemplates.model.entities.RaePK id) {
    ...
    public static class RaeControllerConverter implements Converter {
        ...
        co.edu.sena.ejemplotemplates.model.entities.RaePK getKey(String value) {
            co.edu.sena.ejemplotemplates.model.entities.RaePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.ejemplotemplates.model.entities.RaePK();
        ...
        String getStringKey(co.edu.sena.ejemplotemplates.model.entities.RaePK value) {
