...
public class ItemChecker implements Serializable {
    ...
    @JoinColumn(name = "lista_chequeo", referencedColumnName = "id_lista", insertable = false, updatable = false)
    ...
    @JoinColumns({
        ...
        , @JoinColumn(name = "programa_codigo_version", referencedColumnName = "programa_codigo_version")})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private Rae rae;
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.ItemChecker[ itemCheckerPK=" + itemCheckerPK + " ]";
    }
