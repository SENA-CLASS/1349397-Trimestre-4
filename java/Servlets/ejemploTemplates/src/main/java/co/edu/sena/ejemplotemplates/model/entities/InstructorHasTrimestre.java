...
public class InstructorHasTrimestre implements Serializable {
    ...
    @JoinColumn(name = "tipo_instructor", referencedColumnName = "modalidad", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    ...
    @JoinColumns({
        ...
        , @JoinColumn(name = "jornada", referencedColumnName = "jornada_nombre", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.InstructorHasTrimestre[ instructorHasTrimestrePK=" + instructorHasTrimestrePK + " ]";
    }
