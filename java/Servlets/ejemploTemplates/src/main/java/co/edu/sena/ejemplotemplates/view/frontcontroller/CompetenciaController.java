...
import co.edu.sena.ejemplotemplates.model.entities.Competencia;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.CompetenciaFacade;
...
public class CompetenciaController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.CompetenciaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCompetenciaPK(new co.edu.sena.ejemplotemplates.model.entities.CompetenciaPK());
    }
    ...
    public Competencia getCompetencia(co.edu.sena.ejemplotemplates.model.entities.CompetenciaPK id) {
    ...
    public static class CompetenciaControllerConverter implements Converter {
        ...
        co.edu.sena.ejemplotemplates.model.entities.CompetenciaPK getKey(String value) {
            co.edu.sena.ejemplotemplates.model.entities.CompetenciaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.ejemplotemplates.model.entities.CompetenciaPK();
            key.setCodigo(values[0]);
            key.setProgramaCodigoVersion(values[1]);
            return key;
        }

        String getStringKey(co.edu.sena.ejemplotemplates.model.entities.CompetenciaPK value) {
