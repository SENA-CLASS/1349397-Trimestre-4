...
public class ObservacionItem implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "numero_ficha", referencedColumnName = "ficha", insertable = false, updatable = false)
        , @JoinColumn(name = "grupo_codigo", referencedColumnName = "grupo_codigo", insertable = false, updatable = false)
        , @JoinColumn(name = "lista_chequeo", referencedColumnName = "lista_chequeo", insertable = false, updatable = false)
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.ObservacionItem[ observacionItemPK=" + observacionItemPK + " ]";
    }
