...
import co.edu.sena.ejemplotemplates.controller.ejbs.FichaHasListaFacade;
...
public class FichaHasListaController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.FichaHasListaFacade ejbFacade;
