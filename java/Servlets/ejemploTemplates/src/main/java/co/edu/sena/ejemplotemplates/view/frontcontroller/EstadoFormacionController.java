...
import co.edu.sena.ejemplotemplates.model.entities.EstadoFormacion;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.EstadoFormacionFacade;
...
public class EstadoFormacionController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.EstadoFormacionFacade ejbFacade;
