...
public class ClienteHasRol implements Serializable {
    ...
    @JoinColumn(name = "rol", referencedColumnName = "id_rol", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private Rol rol1;
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.ClienteHasRol[ clienteHasRolPK=" + clienteHasRolPK + " ]";
    }
