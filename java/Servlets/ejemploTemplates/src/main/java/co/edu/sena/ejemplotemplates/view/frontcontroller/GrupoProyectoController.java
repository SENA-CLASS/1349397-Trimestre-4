...
import co.edu.sena.ejemplotemplates.model.entities.GrupoProyecto;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.GrupoProyectoFacade;
...
public class GrupoProyectoController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.GrupoProyectoFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setGrupoProyectoPK(new co.edu.sena.ejemplotemplates.model.entities.GrupoProyectoPK());
    }
    ...
    public GrupoProyecto getGrupoProyecto(co.edu.sena.ejemplotemplates.model.entities.GrupoProyectoPK id) {
    ...
    public static class GrupoProyectoControllerConverter implements Converter {
        ...
        co.edu.sena.ejemplotemplates.model.entities.GrupoProyectoPK getKey(String value) {
            co.edu.sena.ejemplotemplates.model.entities.GrupoProyectoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.ejemplotemplates.model.entities.GrupoProyectoPK();
            key.setNumeroFicha(values[0]);
            key.setCodigo(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(co.edu.sena.ejemplotemplates.model.entities.GrupoProyectoPK value) {
