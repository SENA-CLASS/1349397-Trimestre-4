...
import co.edu.sena.ejemplotemplates.model.entities.Programa;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.ProgramaFacade;
...
public class ProgramaController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.ProgramaFacade ejbFacade;
    ...
    public Programa getPrograma(java.lang.String id) {
    ...
    public static class ProgramaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Programa) {
                ...
                return getStringKey(o.getCodigoVersion());
            } else {
