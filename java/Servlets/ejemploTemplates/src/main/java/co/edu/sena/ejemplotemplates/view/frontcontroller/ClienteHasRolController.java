...
import co.edu.sena.ejemplotemplates.model.entities.ClienteHasRol;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.ClienteHasRolFacade;
...
public class ClienteHasRolController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.ClienteHasRolFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setClienteHasRolPK(new co.edu.sena.ejemplotemplates.model.entities.ClienteHasRolPK());
    }
    ...
    public ClienteHasRol getClienteHasRol(co.edu.sena.ejemplotemplates.model.entities.ClienteHasRolPK id) {
    ...
    public static class ClienteHasRolControllerConverter implements Converter {
        ...
        co.edu.sena.ejemplotemplates.model.entities.ClienteHasRolPK getKey(String value) {
            co.edu.sena.ejemplotemplates.model.entities.ClienteHasRolPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.ejemplotemplates.model.entities.ClienteHasRolPK();
        ...
        String getStringKey(co.edu.sena.ejemplotemplates.model.entities.ClienteHasRolPK value) {
