...
import co.edu.sena.ejemplotemplates.model.entities.InstructorFicha;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.InstructorFichaFacade;
...
public class InstructorFichaController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.InstructorFichaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setInstructorFichaPK(new co.edu.sena.ejemplotemplates.model.entities.InstructorFichaPK());
    }
    ...
    public InstructorFicha getInstructorFicha(co.edu.sena.ejemplotemplates.model.entities.InstructorFichaPK id) {
    ...
    public static class InstructorFichaControllerConverter implements Converter {
        ...
        co.edu.sena.ejemplotemplates.model.entities.InstructorFichaPK getKey(String value) {
            co.edu.sena.ejemplotemplates.model.entities.InstructorFichaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.ejemplotemplates.model.entities.InstructorFichaPK();
        ...
        String getStringKey(co.edu.sena.ejemplotemplates.model.entities.InstructorFichaPK value) {
