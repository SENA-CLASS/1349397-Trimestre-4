...
public class RespuestaGrupo implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "ficha", referencedColumnName = "numero_ficha", insertable = false, updatable = false)
    ...
    @JoinColumn(name = "valoracion_valor", referencedColumnName = "valor")
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.RespuestaGrupo[ respuestaGrupoPK=" + respuestaGrupoPK + " ]";
    }
