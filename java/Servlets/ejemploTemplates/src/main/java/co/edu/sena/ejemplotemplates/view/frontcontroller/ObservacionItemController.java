...
import co.edu.sena.ejemplotemplates.model.entities.ObservacionItem;
...
import co.edu.sena.ejemplotemplates.controller.ejbs.ObservacionItemFacade;
...
public class ObservacionItemController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.ObservacionItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setObservacionItemPK(new co.edu.sena.ejemplotemplates.model.entities.ObservacionItemPK());
    }
    ...
    public ObservacionItem getObservacionItem(co.edu.sena.ejemplotemplates.model.entities.ObservacionItemPK id) {
    ...
    public static class ObservacionItemControllerConverter implements Converter {
        ...
        co.edu.sena.ejemplotemplates.model.entities.ObservacionItemPK getKey(String value) {
            co.edu.sena.ejemplotemplates.model.entities.ObservacionItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.ejemplotemplates.model.entities.ObservacionItemPK();
        ...
        String getStringKey(co.edu.sena.ejemplotemplates.model.entities.ObservacionItemPK value) {
