...
import co.edu.sena.ejemplotemplates.controller.ejbs.LogAuditoriaFacade;
...
public class LogAuditoriaController implements Serializable {
    ...
    @EJB
    private co.edu.sena.ejemplotemplates.controller.ejbs.LogAuditoriaFacade ejbFacade;
