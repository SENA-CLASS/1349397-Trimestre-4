...
public class RaePK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplotemplates.model.entities.RaePK[ codigo=" + codigo + ", competenciaCodigo=" + competenciaCodigo + ", programaCodigoVersion=" + programaCodigoVersion + " ]";
    }
