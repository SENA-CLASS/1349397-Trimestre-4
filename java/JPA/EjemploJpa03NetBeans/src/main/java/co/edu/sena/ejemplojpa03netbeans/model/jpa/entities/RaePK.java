...
public class RaePK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.RaePK[ codigo=" + codigo + ", competenciaCodigo=" + competenciaCodigo + ", programaCodigoVersion=" + programaCodigoVersion + " ]";
    }
