...
public class ItemChecker implements Serializable {
    ...
    @ManyToOne(optional = false)
    private Rae rae;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "itemChecker")
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.ItemChecker[ itemCheckerPK=" + itemCheckerPK + " ]";
    }
