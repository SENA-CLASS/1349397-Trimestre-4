...
public class GrupoProyecto implements Serializable {
    ...
    private Ficha ficha;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "grupoProyecto")
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.GrupoProyecto[ grupoProyectoPK=" + grupoProyectoPK + " ]";
    }
