...
public class ObservacionGeneralPK implements Serializable {
    ...
    @Column(name = "grupo_numero_ficha", nullable = false, length = 20)
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.ObservacionGeneralPK[ grupoNumeroFicha=" + grupoNumeroFicha + ", grupoCodigo=" + grupoCodigo + ", idObservacion=" + idObservacion + " ]";
    }
