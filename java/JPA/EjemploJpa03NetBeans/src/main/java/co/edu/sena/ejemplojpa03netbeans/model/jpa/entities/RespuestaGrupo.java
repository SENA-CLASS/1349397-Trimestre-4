...
public class RespuestaGrupo implements Serializable {
    ...
    private Date fecha;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "respuestaGrupo")
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.RespuestaGrupo[ respuestaGrupoPK=" + respuestaGrupoPK + " ]";
    }
