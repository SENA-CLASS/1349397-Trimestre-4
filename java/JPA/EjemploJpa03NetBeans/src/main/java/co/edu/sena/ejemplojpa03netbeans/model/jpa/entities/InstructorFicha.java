...
public class InstructorFicha implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "instructorFicha")
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.InstructorFicha[ instructorFichaPK=" + instructorFichaPK + " ]";
    }
