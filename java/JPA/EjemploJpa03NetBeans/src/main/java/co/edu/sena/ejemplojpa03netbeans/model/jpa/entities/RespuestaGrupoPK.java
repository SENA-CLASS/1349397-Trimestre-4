...
public class RespuestaGrupoPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.RespuestaGrupoPK[ ficha=" + ficha + ", grupoCodigo=" + grupoCodigo + ", listaChequeo=" + listaChequeo + ", idItem=" + idItem + " ]";
    }
