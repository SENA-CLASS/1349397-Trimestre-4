...
public class AprendizPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplojpa03netbeans.model.jpa.entities.AprendizPK[ tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento + ", ficha=" + ficha + ", grupoCodigo=" + grupoCodigo + " ]";
    }
