...
import co.edu.sena.mavenproject2.model.entities.ItemChecker;
...
import co.edu.sena.mavenproject2.controller.ejbs.ItemCheckerFacade;
...
public class ItemCheckerController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.ItemCheckerFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemCheckerPK(new co.edu.sena.mavenproject2.model.entities.ItemCheckerPK());
    }
    ...
    public ItemChecker getItemChecker(co.edu.sena.mavenproject2.model.entities.ItemCheckerPK id) {
    ...
    public static class ItemCheckerControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.ItemCheckerPK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.ItemCheckerPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.ItemCheckerPK();
            key.setListaChequeo(values[0]);
            key.setIdItem(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(co.edu.sena.mavenproject2.model.entities.ItemCheckerPK value) {
