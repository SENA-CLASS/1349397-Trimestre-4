...
import co.edu.sena.mavenproject2.model.entities.Trimestre;
...
import co.edu.sena.mavenproject2.controller.ejbs.TrimestreFacade;
...
public class TrimestreController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.TrimestreFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setTrimestrePK(new co.edu.sena.mavenproject2.model.entities.TrimestrePK());
    }
    ...
    public Trimestre getTrimestre(co.edu.sena.mavenproject2.model.entities.TrimestrePK id) {
    ...
    public static class TrimestreControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.TrimestrePK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.TrimestrePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.TrimestrePK();
            key.setIdTrimestre(values[0]);
            key.setJornadaNombre(values[1]);
            return key;
        }

        String getStringKey(co.edu.sena.mavenproject2.model.entities.TrimestrePK value) {
