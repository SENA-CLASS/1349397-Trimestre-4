...
import co.edu.sena.mavenproject2.model.entities.Aprendiz;
...
import co.edu.sena.mavenproject2.controller.ejbs.AprendizFacade;
...
public class AprendizController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.AprendizFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setAprendizPK(new co.edu.sena.mavenproject2.model.entities.AprendizPK());
    }
    ...
    public Aprendiz getAprendiz(co.edu.sena.mavenproject2.model.entities.AprendizPK id) {
    ...
    public static class AprendizControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.AprendizPK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.AprendizPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.AprendizPK();
        ...
        String getStringKey(co.edu.sena.mavenproject2.model.entities.AprendizPK value) {
