...
import co.edu.sena.mavenproject2.model.entities.ObservacionGeneral;
...
import co.edu.sena.mavenproject2.controller.ejbs.ObservacionGeneralFacade;
...
public class ObservacionGeneralController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.ObservacionGeneralFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setObservacionGeneralPK(new co.edu.sena.mavenproject2.model.entities.ObservacionGeneralPK());
    }
    ...
    public ObservacionGeneral getObservacionGeneral(co.edu.sena.mavenproject2.model.entities.ObservacionGeneralPK id) {
    ...
    public static class ObservacionGeneralControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.ObservacionGeneralPK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.ObservacionGeneralPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.ObservacionGeneralPK();
        ...
        String getStringKey(co.edu.sena.mavenproject2.model.entities.ObservacionGeneralPK value) {
