...
import co.edu.sena.mavenproject2.model.entities.RespuestaGrupo;
...
import co.edu.sena.mavenproject2.controller.ejbs.RespuestaGrupoFacade;
...
public class RespuestaGrupoController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.RespuestaGrupoFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setRespuestaGrupoPK(new co.edu.sena.mavenproject2.model.entities.RespuestaGrupoPK());
    }
    ...
    public RespuestaGrupo getRespuestaGrupo(co.edu.sena.mavenproject2.model.entities.RespuestaGrupoPK id) {
    ...
    public static class RespuestaGrupoControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.RespuestaGrupoPK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.RespuestaGrupoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.RespuestaGrupoPK();
        ...
        String getStringKey(co.edu.sena.mavenproject2.model.entities.RespuestaGrupoPK value) {
