...
public class AprendizPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.mavenproject2.model.entities.AprendizPK[ tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento + ", ficha=" + ficha + ", grupoCodigo=" + grupoCodigo + " ]";
    }
