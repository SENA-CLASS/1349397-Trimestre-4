...
import co.edu.sena.mavenproject2.model.entities.ClienteHasRol;
...
import co.edu.sena.mavenproject2.controller.ejbs.ClienteHasRolFacade;
...
public class ClienteHasRolController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.ClienteHasRolFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setClienteHasRolPK(new co.edu.sena.mavenproject2.model.entities.ClienteHasRolPK());
    }
    ...
    public ClienteHasRol getClienteHasRol(co.edu.sena.mavenproject2.model.entities.ClienteHasRolPK id) {
    ...
    public static class ClienteHasRolControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.ClienteHasRolPK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.ClienteHasRolPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.ClienteHasRolPK();
        ...
        String getStringKey(co.edu.sena.mavenproject2.model.entities.ClienteHasRolPK value) {
