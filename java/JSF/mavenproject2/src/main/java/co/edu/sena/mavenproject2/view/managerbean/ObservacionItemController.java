...
import co.edu.sena.mavenproject2.model.entities.ObservacionItem;
...
import co.edu.sena.mavenproject2.controller.ejbs.ObservacionItemFacade;
...
public class ObservacionItemController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.ObservacionItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setObservacionItemPK(new co.edu.sena.mavenproject2.model.entities.ObservacionItemPK());
    }
    ...
    public ObservacionItem getObservacionItem(co.edu.sena.mavenproject2.model.entities.ObservacionItemPK id) {
    ...
    public static class ObservacionItemControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.ObservacionItemPK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.ObservacionItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.ObservacionItemPK();
        ...
        String getStringKey(co.edu.sena.mavenproject2.model.entities.ObservacionItemPK value) {
