...
public class ObservacionGeneralPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.mavenproject2.model.entities.ObservacionGeneralPK[ grupoNumeroFicha=" + grupoNumeroFicha + ", grupoCodigo=" + grupoCodigo + ", idObservacion=" + idObservacion + " ]";
    }
