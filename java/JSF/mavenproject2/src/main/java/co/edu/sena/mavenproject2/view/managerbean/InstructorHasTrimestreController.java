...
import co.edu.sena.mavenproject2.model.entities.InstructorHasTrimestre;
...
import co.edu.sena.mavenproject2.controller.ejbs.InstructorHasTrimestreFacade;
...
public class InstructorHasTrimestreController implements Serializable {
    ...
    @EJB
    private co.edu.sena.mavenproject2.controller.ejbs.InstructorHasTrimestreFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setInstructorHasTrimestrePK(new co.edu.sena.mavenproject2.model.entities.InstructorHasTrimestrePK());
    }
    ...
    public InstructorHasTrimestre getInstructorHasTrimestre(co.edu.sena.mavenproject2.model.entities.InstructorHasTrimestrePK id) {
    ...
    public static class InstructorHasTrimestreControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject2.model.entities.InstructorHasTrimestrePK getKey(String value) {
            co.edu.sena.mavenproject2.model.entities.InstructorHasTrimestrePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject2.model.entities.InstructorHasTrimestrePK();
        ...
        String getStringKey(co.edu.sena.mavenproject2.model.entities.InstructorHasTrimestrePK value) {
