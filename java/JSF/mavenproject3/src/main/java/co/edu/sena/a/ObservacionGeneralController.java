...
import co.edu.sena.mavenproject3.ObservacionGeneral;
...
public class ObservacionGeneralController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.ObservacionGeneralFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setObservacionGeneralPK(new co.edu.sena.mavenproject3.ObservacionGeneralPK());
    }
    ...
    public ObservacionGeneral getObservacionGeneral(co.edu.sena.mavenproject3.ObservacionGeneralPK id) {
    ...
    public static class ObservacionGeneralControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.ObservacionGeneralPK getKey(String value) {
            co.edu.sena.mavenproject3.ObservacionGeneralPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.ObservacionGeneralPK();
        ...
        String getStringKey(co.edu.sena.mavenproject3.ObservacionGeneralPK value) {
