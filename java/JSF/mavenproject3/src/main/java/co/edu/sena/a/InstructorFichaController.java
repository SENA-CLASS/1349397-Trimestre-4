...
import co.edu.sena.mavenproject3.InstructorFicha;
...
public class InstructorFichaController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.InstructorFichaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setInstructorFichaPK(new co.edu.sena.mavenproject3.InstructorFichaPK());
    }
    ...
    public InstructorFicha getInstructorFicha(co.edu.sena.mavenproject3.InstructorFichaPK id) {
    ...
    public static class InstructorFichaControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.InstructorFichaPK getKey(String value) {
            co.edu.sena.mavenproject3.InstructorFichaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.InstructorFichaPK();
        ...
        String getStringKey(co.edu.sena.mavenproject3.InstructorFichaPK value) {
