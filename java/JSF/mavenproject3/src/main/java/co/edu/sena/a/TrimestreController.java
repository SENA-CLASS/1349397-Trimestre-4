...
import co.edu.sena.mavenproject3.Trimestre;
...
public class TrimestreController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.TrimestreFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setTrimestrePK(new co.edu.sena.mavenproject3.TrimestrePK());
    }
    ...
    public Trimestre getTrimestre(co.edu.sena.mavenproject3.TrimestrePK id) {
    ...
    public static class TrimestreControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.TrimestrePK getKey(String value) {
            co.edu.sena.mavenproject3.TrimestrePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.TrimestrePK();
            key.setIdTrimestre(values[0]);
            key.setJornadaNombre(values[1]);
            return key;
        }

        String getStringKey(co.edu.sena.mavenproject3.TrimestrePK value) {
