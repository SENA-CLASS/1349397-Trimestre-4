...
import co.edu.sena.mavenproject3.Aprendiz;
...
public class AprendizController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.AprendizFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setAprendizPK(new co.edu.sena.mavenproject3.AprendizPK());
    }
    ...
    public Aprendiz getAprendiz(co.edu.sena.mavenproject3.AprendizPK id) {
    ...
    public static class AprendizControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.AprendizPK getKey(String value) {
            co.edu.sena.mavenproject3.AprendizPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.AprendizPK();
        ...
        String getStringKey(co.edu.sena.mavenproject3.AprendizPK value) {
