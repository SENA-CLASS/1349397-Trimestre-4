...
import co.edu.sena.mavenproject3.Cliente;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.ClienteFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setClientePK(new co.edu.sena.mavenproject3.ClientePK());
    }
    ...
    public Cliente getCliente(co.edu.sena.mavenproject3.ClientePK id) {
    ...
    public static class ClienteControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.ClientePK getKey(String value) {
            co.edu.sena.mavenproject3.ClientePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.ClientePK();
            key.setTipoDocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(co.edu.sena.mavenproject3.ClientePK value) {
