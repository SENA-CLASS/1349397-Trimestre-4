...
import co.edu.sena.mavenproject3.ItemChecker;
...
public class ItemCheckerController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.ItemCheckerFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemCheckerPK(new co.edu.sena.mavenproject3.ItemCheckerPK());
    }
    ...
    public ItemChecker getItemChecker(co.edu.sena.mavenproject3.ItemCheckerPK id) {
    ...
    public static class ItemCheckerControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.ItemCheckerPK getKey(String value) {
            co.edu.sena.mavenproject3.ItemCheckerPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.ItemCheckerPK();
            key.setListaChequeo(values[0]);
            key.setIdItem(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(co.edu.sena.mavenproject3.ItemCheckerPK value) {
