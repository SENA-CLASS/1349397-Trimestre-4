...
import co.edu.sena.mavenproject3.GrupoProyecto;
...
public class GrupoProyectoController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.GrupoProyectoFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setGrupoProyectoPK(new co.edu.sena.mavenproject3.GrupoProyectoPK());
    }
    ...
    public GrupoProyecto getGrupoProyecto(co.edu.sena.mavenproject3.GrupoProyectoPK id) {
    ...
    public static class GrupoProyectoControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.GrupoProyectoPK getKey(String value) {
            co.edu.sena.mavenproject3.GrupoProyectoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.GrupoProyectoPK();
            key.setNumeroFicha(values[0]);
            key.setCodigo(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(co.edu.sena.mavenproject3.GrupoProyectoPK value) {
