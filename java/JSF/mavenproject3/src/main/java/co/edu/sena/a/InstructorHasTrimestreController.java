...
import co.edu.sena.mavenproject3.InstructorHasTrimestre;
...
public class InstructorHasTrimestreController implements Serializable {
    ...
    @EJB
    private co.edu.sena.a.InstructorHasTrimestreFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setInstructorHasTrimestrePK(new co.edu.sena.mavenproject3.InstructorHasTrimestrePK());
    }
    ...
    public InstructorHasTrimestre getInstructorHasTrimestre(co.edu.sena.mavenproject3.InstructorHasTrimestrePK id) {
    ...
    public static class InstructorHasTrimestreControllerConverter implements Converter {
        ...
        co.edu.sena.mavenproject3.InstructorHasTrimestrePK getKey(String value) {
            co.edu.sena.mavenproject3.InstructorHasTrimestrePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new co.edu.sena.mavenproject3.InstructorHasTrimestrePK();
        ...
        String getStringKey(co.edu.sena.mavenproject3.InstructorHasTrimestrePK value) {
