...
public class ObservacionGeneralPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplojsf.model.entities.ObservacionGeneralPK[ grupoNumeroFicha=" + grupoNumeroFicha + ", grupoCodigo=" + grupoCodigo + ", idObservacion=" + idObservacion + " ]";
    }
