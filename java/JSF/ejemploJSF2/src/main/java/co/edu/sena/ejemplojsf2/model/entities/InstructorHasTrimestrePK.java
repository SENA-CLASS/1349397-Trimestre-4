...
public class InstructorHasTrimestrePK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplojsf2.model.entities.InstructorHasTrimestrePK[ tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento + ", ficha=" + ficha + ", idTrimestre=" + idTrimestre + ", jornada=" + jornada + ", tipoInstructor=" + tipoInstructor + " ]";
    }
