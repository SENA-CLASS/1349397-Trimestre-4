...
public class ObservacionItemPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplojsf2.model.entities.ObservacionItemPK[ idObservacion=" + idObservacion + ", numeroFicha=" + numeroFicha + ", grupoCodigo=" + grupoCodigo + ", listaChequeo=" + listaChequeo + ", idItem=" + idItem + " ]";
    }
