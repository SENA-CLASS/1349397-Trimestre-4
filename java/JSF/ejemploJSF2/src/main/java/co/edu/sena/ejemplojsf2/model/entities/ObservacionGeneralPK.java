...
public class ObservacionGeneralPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemplojsf2.model.entities.ObservacionGeneralPK[ grupoNumeroFicha=" + grupoNumeroFicha + ", grupoCodigo=" + grupoCodigo + ", idObservacion=" + idObservacion + " ]";
    }
