...
public class AprendizPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.ejemploproyecto.model.entities.AprendizPK[ tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento + ", ficha=" + ficha + ", grupoCodigo=" + grupoCodigo + " ]";
    }
